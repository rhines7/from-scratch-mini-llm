...
penalties. A key-value cache makes single-prompt generation incremental. At this
model scale the samples are locally coherent and reflect the simple TinyStories
style rather than long-range narrative structure.
